  ...
  <div class="formbold-form-wrapper">
    ...
    <form action="https://formbold.com/s/FORM_ID" method="POST">
      ...
      <div class="formbold-input-flex">
        ...
        <div>
          <label for="lastname" class="formbold-form-label"> Due date </label>
          <input
            type="text"
            name="lastname"
            id="lastname"
            value="{{$chapter->due_date}}"
            class="formbold-form-input"
         readonly />
        </div>
      </div>
      ...
      <div class="formbold-input-flex">
        <div>
          <label for="email" class="formbold-form-label"> Project Supervisor </label>
          <input
            type="email"
            name="email"
            id="email"
            class="formbold-form-input"
            value="{{$chapter->project_supervisor}}"
          readonly/>
        </div>
        <div>
          <label for="phone" class="formbold-form-label"> Submitted At </label>
          <input
            type="text"
            name="phone"
            id="phone"
            class="formbold-form-input"
           value="{{ $chapter->created_at->format('Y-m-d') }}"
          readonly/>
        </div>
      </div>
      ...
      <div class="formbold-mb-3">
        ...
        <input
          ...
          id="address"
          class="formbold-form-input"
          value="{{$chapter->title_evaluation}}"
        />
      </div>
      ...
      <div class="formbold-mb-3">
        ...
        <input
          ...
          id="address2"
          class="formbold-form-input"
          value="{{$chapter->methodology_evaluation}}"
        />
      </div>

      <div class="formbold-input-flex">
        <div>
          <label for="state" class="formbold-form-label"> Literature Review Evaluation </label>
          <input
            type="text"
            name="state"
            id="state"
            class="formbold-form-input"
            value="{{$chapter->literature_review_evaluation}}"
          />
        </div>
        <div>
          <label for="country" class="formbold-form-label"> Research Question Evaluation </label>
          <input
            type="text"
            name="country"
            id="country"
            class="formbold-form-input"
            value="{{$chapter->research_question_evaluation}}"
          />
        </div>
      </div>
      ...
      <div class="formbold-input-flex">
        <div>
          <label for="post" class="formbold-form-label"> Data Collection Evaluation </label>
          <input
            type="text"
            name="post"
            id="post"
            class="formbold-form-input"
            value="{{$chapter->data_collection_evaluation}}"
          />
        </div>
        <div>
          <label for="area" class="formbold-form-label"> Data Analysis Evaluation </label>
          <input
            type="text"
            name="area"
            id="area"
            class="formbold-form-input"
            value="{{$chapter->data_analysis_evaluation}}"
          />
        </div>
      </div>
