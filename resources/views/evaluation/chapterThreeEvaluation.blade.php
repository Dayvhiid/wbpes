      ...
      <form action="https://formbold.com/s/FORM_ID" method="POST">
        ...
        <div class="formbold-mb-3">
          ...
          <input
            ...
            id="address"
            class="formbold-form-input"
            value="{{$chapter->dataCollectionMethods}}"
          />
        </div>
        ...
        <div class="formbold-mb-3">
          ...
          <input
            ...
            id="address2"
            class="formbold-form-input"
            value="{{$chapter->justificationOfMethodology}}"
          />
        </div>
