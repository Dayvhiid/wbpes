      ...
      <form action="https://formbold.com/s/FORM_ID" method="POST">
        ...
        <div class="formbold-mb-3">
          ...
          <input
            ...
            id="address"
            class="formbold-form-input"
            value="{{$chapter->backgroundOfStudy}}"
          />
        </div>
        ...
        <div class="formbold-mb-3">
          ...
          <input
            ...
            id="address2"
            class="formbold-form-input"
            value="{{$chapter->statementOfTheProject}}"
          />
        </div>
        ...
        <div class="formbold-mb-3">
            ...
            <input
              ...
              id="address2"
              class="formbold-form-input"
              value="{{$chapter->aimsAndObjectives}}"
            />
        </div>
        ...
        <div class="formbold-mb-3">
            ...
            <input
              ...
              id="address2"
              class="formbold-form-input"
              value="{{$chapter->justificationOfStudy}}"
            />
        </div>
        ...
        <div class="formbold-mb-3">
            ...
            <input
              ...
              id="address2"
              class="formbold-form-input"
              value="{{$chapter->significanceOfTheProject}}"
            />
        </div>
        ...
        <div class="formbold-mb-3">
            ...
            <input
              ...
              id="address2"
              class="formbold-form-input"
              value="{{$chapter->organizationOfTheProject}}"
            />
        </div>
